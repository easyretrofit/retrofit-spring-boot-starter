...
import com.github.liuziyuan.retrofit.demo.api.HelloApi;
import com.github.liuziyuan.retrofit.demo.api.HelloInheritApi;
import com.github.liuziyuan.retrofit.demo.api.TestApi;
...
class RetrofitResourceScannerTest {
    ...
    @Test
    void doScan() {
        final Set<Class<?>> classSet = scanner.doScan("com.github.liuziyuan.retrofit.demo.api");
