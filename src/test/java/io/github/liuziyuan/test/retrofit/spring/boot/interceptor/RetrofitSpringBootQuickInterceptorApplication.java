 ...
 */
@EnableRetrofit({"io.github.liuziyuan.test.retrofit.spring.boot.interceptor"})
@SpringBootApplication
public class RetrofitSpringBootQuickInterceptorApplication {
    public static void main(String[] args) {
        ConfigurableApplicationContext run = SpringApplication.run(RetrofitSpringBootQuickInterceptorApplication.class, args);
