...
| retrofit-core | retrofit-spring-boot-starter | retrofit-spring-boot-reactor-starter<br/>retrofit-spring-boot-web-starter | retrofit-extension-loadbalancer-spring-cloud-starter<br/>retrofit-extension-sentinel-spring-boot-starter |
|---------------|------------------------------|---------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| 1.2.1         | 1.3.5                        | 1.4.1                                                                     | 1.1.1                                                                                                    |
| 1.2.0         | 1.3.4                        | 1.4.0                                                                     | 1.1.0                                                                                                    |                              |                                                                           |
| 1.1.4         | 1.3.3                        | 1.3.0                                                                     | 1.0.0                                                                                                    |
